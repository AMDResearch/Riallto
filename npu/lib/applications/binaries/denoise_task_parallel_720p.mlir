...
module @denoise_aie2 {
 	...
 	AIE.device(ipu) {
        ...
        func.func private @addWeightedLine(%in1: memref<1280xui8>, %in2: memref<1280xui8>, %out: memref<1280xui8>, %tileWidth: i32, %alpha: i16, %beta: i16, %gamma: i8) -> ()
        ...
        AIE.objectFifo @inOF_L3L1(%tile00, {%tile02}, 2 : i32) : !AIE.objectFifo<memref<5120xui8>>
        
        AIE.objectFifo @outOFL2L3(%tile01, {%tile00}, 2 : i32) : !AIE.objectFifo<memref<1280xui8>>
        AIE.objectFifo @outOFL1L2(%tile05, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<1280xui8>>
        AIE.objectFifo.link [@outOFL1L2] -> [@outOFL2L3] ()

        // Declare task to task object FIFOs

        AIE.objectFifo @OF_2to34(%tile02, {%tile03,%tile04}, [2,2,4])  : !AIE.objectFifo<memref<1280xui8>>
        ...
        %core03 = AIE.core(%tile03) {
            ...
            scf.for %rep = %c0 to %intmax step %c1 {
                ...
                func.call @median1DLine(%elem0, %elemOut, %tileWidth) : (memref<1280xui8>, memref<1280xui8>, i32) -> ()
        ...
        %core04 = AIE.core(%tile04) {
            ...
            scf.for %iter = %c0 to %intmax step %c1 { 
                // Acquire objectFifos and get subviews
                %subviewIn0 = AIE.objectFifo.acquire @OF_2to34(Consume, 1) : !AIE.objectFifoSubview<memref<1280xui8>>
                %elemIn0 = AIE.objectFifo.subview.access %subviewIn0[0] : !AIE.objectFifoSubview<memref<1280xui8>> -> memref<1280xui8>
                %subviewIn1 = AIE.objectFifo.acquire @OF_3to4(Consume, 1) : !AIE.objectFifoSubview<memref<1280xui8>>
                ...
                func.call @addWeightedLine(%elemIn0, %elemIn1, %elemOut, %tileWidth, %alpha, %beta, %gamma) : (memref<1280xui8>, memref<1280xui8>, memref<1280xui8>, i32, i16, i16, i8) -> ()
        ...
        %core05 = AIE.core(%tile05) {
            ...
            scf.for %rep = %c0 to %intmax step %c1 {
                ...
                %elem0 = AIE.objectFifo.subview.access %subviewIn[0] : !AIE.objectFifoSubview<memref<1280xui8>> -> memref<1280xui8>
                %subviewOut = AIE.objectFifo.acquire @outOFL1L2(Produce, 1) : !AIE.objectFifoSubview<memref<1280xui8>>
                %elemOut = AIE.objectFifo.subview.access %subviewOut[0] : !AIE.objectFifoSubview<memref<1280xui8>> -> memref<1280xui8>
                ...
                //func.call @dilate1DLine(%elem0, %elemOut, %tileWidth) : (memref<1280xui8>, memref<1280xui8>, i32) -> ()
                func.call @thresholdLine(%elem0, %elemOut, %tileWidth, %thresholdValue, %maxValue, %thresholdModeBinary) : (memref<1280xui8>, memref<1280xui8>, i32, i16, i16, i16) -> ()
        ...
        func.func @sequence(%in : memref<720x1280xi32>, %out : memref<720x320xi32>) {
            ...
            %totalLenGray   = arith.constant  230400 : i32
            ...
            AIEX.ipu.dma_memcpy_nd (%c0, %c0, %out[%c0, %c0, %c0, %c0][%c1, %c1, %c1, %totalLenGray][%c0, %c0, %c0]) { metadata = @outOFL2L3, id = 0 : i32 } : (i32, i32, memref<720x320xi32>,  [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])

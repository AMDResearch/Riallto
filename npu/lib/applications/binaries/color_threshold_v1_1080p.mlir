...
module {
  AIE.device(ipu) {
    ...
    // For 1080p rgba:
    func.func @sequence(%in : memref<2073600xi32>, %out : memref<2073600xi32>) {
      %c0 = arith.constant 0 : i32
      %c1 = arith.constant 1 : i32
      %c2073600 = arith.constant 2073600 : i32
      ...
      AIEX.ipu.dma_memcpy_nd (%c0, %c0, %out[%c0,%c0,%c0,%c0][%c1,%c1,%c1,%c2073600][%c0,%c0,%c0]) { metadata = @objFifo_out0, id = 1 : i32 } : (i32, i32, memref<2073600xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
      AIEX.ipu.dma_memcpy_nd (%c0, %c0, %in[%c0,%c0,%c0,%c0][%c1,%c1,%c1,%c2073600][%c0,%c0,%c0]) { metadata = @objFifo_in0, id = 0 : i32 } : (i32, i32, memref<2073600xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
